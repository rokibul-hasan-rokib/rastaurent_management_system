        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            ...
            <div class="d-flex">
                <div class="per-page me-2">
                    {{html()->select('per_page', [10=>10, 20=>20, 50=>50, 100=>100], $search['per_page'] ?? \App\Manager\Constants\GlobalConstants::DEFAULT_PAGINATION)->class('form-select form-select-sm')->id('per_page_input') }}
                </div>
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                @else
                                    ...
                                    @endphp
                                    <li class="page-item"><a class="page-link" href="{{ $formatted_url }}">{{ $page }}</a></li>
                                @endif
                            @endforeach
                        @endif
                    @endforeach
